...
public class Click {
	...
	static final long customDelay = 250L; // 서버 지연시간등을 생각한 
	static final long allowDelay = 150L; //api 지연시간으로 인한 밀리초 단위 오차를 최소화하기위해 이변수값 이상 지연발생시 재측정
	
	final static String URL = "https://www.???.com";
	public static void main(String[] args) {
        try {
            ...
            // 2. 특정 시간에 클릭 이벤트 트리거
            LocalTime targetTime = LocalTime.parse("13:00:00", DateTimeFormatter.ofPattern("HH:mm:ss"));
